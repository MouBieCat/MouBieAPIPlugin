...
import com.cat.moubieapi.api.Utils;
import com.cat.moubieapi.api.yaml.YamlSection;
...
public class YamlModuleAbstract
     ...
     */
    public YamlModuleAbstract(final @NotNull Plugin plugin, final @NotNull String path, final @NotNull String name, final boolean isNewFile) {
